...
public class MenuServiceImpl implements MenuService {
    ...
    public MenuServiceImpl(MenuDao menuDao, MenuMapper menuMapper, RoleService roleService) {
...
//        Sort sort = new Sort(Sort.Direction.DESC,"id");
    ...
    public List<MenuDTO> findByRoles(List<RoleSmallDTO> roles) {
        ...
        LinkedHashSet<Menu> menus = menuDao.findByRoles_IdInAndTypeNotOrderBySortAsc(roleIds, 2);
    ...
    public MenuDTO create(Menu menu) {
        ...
        if (StringUtils.isNotBlank(menu.getComponentName())) {
            if (menuDao.findByComponentName(menu.getComponentName()) != null) {
        ...
        return menuMapper.toDto(menuDao.save(menu));
    }
    ...
    public void update(Menu resources) {
        ...
        if (StringUtils.isNotBlank(resources.getComponentName())) {
            menu1 = menuDao.findByComponentName(resources.getComponentName());
            if (menu1 != null && !menu1.getId().equals(menu.getId())) {
    ...
    public Set<Menu> getDeleteMenus(List<Menu> menuList, Set<Menu> menuSet) {
        ...
        for (Menu menu1 : menuList) {
            menuSet.add(menu1);
            List<Menu> menus = menuDao.findByPid(menu1.getId());
