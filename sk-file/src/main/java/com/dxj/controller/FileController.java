...
import com.dxj.manager.FileManageFactory;
import com.dxj.manager.impl.LocalFileManage;
import com.dxj.service.FileService;
...
public class FileController {
    ...
    public Result<Page<File>> getFileList(@ModelAttribute File file,
        ...
        page.getContent().forEach(e -> {
            if (CommonConstant.OSS_LOCAL == e.getLocation()) {
    ...
    public Result<Object> copy(@RequestParam String id,
        ...
        // 特殊处理本地服务器
        if (CommonConstant.OSS_LOCAL == file.getLocation()) {
            key = file.getUrl();
        }
