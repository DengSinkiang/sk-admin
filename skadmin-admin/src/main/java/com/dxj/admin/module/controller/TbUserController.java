...
public class TbUserController {
    ...
    public ResponseEntity<Object> getTbUsers(TbUserQuery criteria, Pageable pageable) {
    ...
    public ResponseEntity<TbUserDTO> create(@Validated @RequestBody TbUser resources) {
